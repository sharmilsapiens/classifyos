...
_ROLE_INSTRUCTIONS = (
    ...
    "ORIGINAL feature values. Use the contributions ONLY to decide which top 10 features mattered most "
    "and in which direction.\n"
    "\n"
    "Write 7-10 flowing sentences for an underwriter. Rules:\n"
    ...
    "- Name top 10 strongest drivers, referring to them by business meaning (use the dataset "
